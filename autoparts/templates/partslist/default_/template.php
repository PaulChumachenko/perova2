...
<?=TDMShowSEOText("TOP")?>
<marquee class="hidden-xs"><b><font color="#B22222">  ВНИМАНИЕ !!!</font> В связи с тем, что у нас несколько складов и поставщиков товара, на товарах отображается несколько цен - выбирайте <font color="#B22222">наиболее подходящий для Вас вариант</font> (например низкая цена, или кратчайший срок доставки). <font color="#B22222">На качество товара это никак не влияет. </font></b></marquee>
