	...
	<b style="font-size:12px; color: #000;"  valign="top" align="center" class="day ttip" <?= Lng('Dtime_delivery',1,0)?>"><?=Lng('В пути:',1,1) ?><?= TDM_ISADMIN ? 'title="' . $arPrice['INFO'] . '"' : '' ?>
				...
				<p style="font-size:24px;" valign="top" align="center" class="cost ttip">
								...
								<br><br><br>
									...
									<button type="button" class="btn btn-primary buy" class="tdcartadd" OnClick="TDMAddToCart('<?= $arPrice['PHID'] ?>')"><img src="https://partix.com.ua/autoparts/media/cart/But.png" width="35" height="25" style="vertical-align: middle">В корзину</button>
